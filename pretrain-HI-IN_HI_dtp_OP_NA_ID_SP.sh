...
#SBATCH --job-name=HI-IN_HI_dtp_OP_NA_ID_SP-1.71B
#SBATCH --nodes=16
...
REGISTER_6=ID
REGISTER_7=SP
REGISTER="${REGISTER_1}_${REGISTER_2}_${REGISTER_3}_${REGISTER_4}_${REGISTER_5}_${REGISTER_6}_${REGISTER_7}"
...
data1="0.15 ${TRAIN_DATA_PATH}/${REGISTER_1}/eng_Latn_text_document"
data2="0.15 ${TRAIN_DATA_PATH}/${REGISTER_2}/eng_Latn_text_document"
data3="0.14 ${TRAIN_DATA_PATH}/${REGISTER_3}/eng_Latn_text_document"
data4="0.14 ${TRAIN_DATA_PATH}/${REGISTER_4}/eng_Latn_text_document"
data5="0.14 ${TRAIN_DATA_PATH}/${REGISTER_5}/eng_Latn_text_document"
data6="0.14 ${TRAIN_DATA_PATH}/${REGISTER_6}/eng_Latn_text_document"
data7="0.14 ${TRAIN_DATA_PATH}/${REGISTER_7}/eng_Latn_text_document"

#TRAIN_DATA="0.2 ${TRAIN_DATA_PATH}/${REGISTER_1}/eng_Latn_text_document 0.5 ${TRAIN_DATA_PATH}/${REGISTER_2}/eng_Latn_text_document"
TRAIN_DATA="${data1} ${data2} ${data3} ${data4} ${data5} ${data6} ${data7}"
